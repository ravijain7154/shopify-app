...
@license
  ...
  Documentation - https://archetypethemes.co/blogs/gem/javascript-events-for-developers
  ...
  theme.Product = (function() {
    ...
    function Product(container) {
      ...
      this.settings = {
        ...
        mediaGalleryLayout: container.querySelector('[data-product-images]')?.dataset.mediaGalleryLayout,
        hasVideos: container.querySelector(selectors.productVideo) ? true : false,
        hasModels: container.querySelector('[data-product-media-type-model]') ? true : false,
      };
    ...
    Product.prototype = Object.assign({}, Product.prototype, {
      ...
      handleStackedMediaChange: function(index) {
        ...
        if (this.settings.hasVideos) {
          ...
          const video = mediaTarget.querySelector(selectors.productVideo);
          if (video) {
      ...
      scrollToStackedMedia: function(index) {
        const mediaTarget = this.container.querySelectorAll('.product-slideshow .product-main-slide')[index];
      ...
      openModalProduct: function() {
        ...
        if (!this.settings.modalInit) {
          ...
          initialized = true;
          if (!theme.config.bpSmall && this.settings.mediaGalleryLayout === 'stacked') {
            this.handleStackedMediaChange(0);
          }
        }
      ...
      closeModalProduct: function() {
        ...
        if (this.mediaObservers && this.mediaObservers.length > 0) {
          this.mediaObservers.forEach(observer => {
            observer.disconnect();
          });
        }
      },
        ...
        document.querySelectorAll(this.selectors.closeMedia).forEach(el => {
          el.addEventListener('click', function() {
            ...
            if (this.settings.mediaGalleryLayout === 'stacked') {
              var slide = this.cache.mainSlider.querySelector(`.product-main-slide[data-index="${this.settings.currentSlideIndex}"]`);
            } else {
              var slide = this.cache.mainSlider.querySelector(selectors.currentSlide);
            }
...
// Retrieve data from local storage
    ...
    if (selectedVariantId || selectedRingId || selectedDiamondId || selectedDVariantId ) {
        console.log('Selected Variant ID:', selectedVariantId);
        console.log('Selected Ring ID:', selectedRingId);
        console.log('Selected Diamond ID:', selectedDiamondId);
        console.log('Selected Diamond V ID:', selectedDVariantId);
    } else {
